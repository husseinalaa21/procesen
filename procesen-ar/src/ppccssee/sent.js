    ...
    setAvd(ax) {
        return (
            <tr className={ax.tn ? "deExcon" : "edExcon"} key={18 + ax.nu}>{ax.tn ? <><td className="trfEx deExTf"> {ax.n} </td >
                <td> حذف </td ></> : <><td className="trfEx edExTf">{ax.n}</td >
                    ...
                    <div style={this.state.areaControl ? { display: 'none' } : { display: 'block' }}>
                        <div className={this.props.bThem ? "ddTable ddTableDr" : "ddTable ddTableLi"}>
                            <div className="seInfCurTable">
                                ...
                                <div className="sict_text sictLi"> الخيارات الاساسية للتحكم بالنص . </div>
                            </div>
                        ...
                        <div className={this.props.bThem ? "ddTable ddTableDr" : "ddTable ddTableLi"}>
                            <div className="seInfCurTable">
                                <div className="sict_logo sictLiIc"> <FontAwesomeIcon icon={faEraser} /> </div>
                                <div className="sict_text sictLi"> الخيارت المتقدمة للتحكم بالنص .  </div>
                            </div>
                            <div className="_scsinf">
                                <div className="conLisSp">
                                    ...
                                    <div className="conLisCr">
                                        ...
                                        <div className="conLisCrSxTi">
                                            <div className={this.state.isclc ? "conLisCrTiA conLisCrTiT" : "conLisCrTiA conLisCrTiFalse"} onClick={() => { this.setState({ isclc: !this.state.isclc }) }}> أستبدال كلمة بأخرى </div>
                        ...
                        <div className="secTwSitc" style={this.state.shMoTo ? { display: "block" } : { display: "none" }}>
                            <div className={this.props.bThem ? "ddTable ddTableDr" : "ddTable ddTableLi"}>
                                <div className="seInfCurTable">
                                    ...
                                    <div className="sict_text sictLi"> معلومات النص </div>
                                </div>
                                <div className="_scsinf">
                                    <div>
                                        <div className="noteWeInf nift">
                                            <EPoin n={numTextLen[2]} />
                                            <div className="niftT"> اعلى عنصر في الجملة هو {numTextLen[2]} , حيث يشكل {numTextLen[2]} % من الجملة . </div>
                                        </div>
                                        <div className="noteWeInf nift">
                                            <EPoin n={numTextLen[2]} />
                                            <div className="niftT"> نسبة التغيير في النص هي {numTextLen[2]} % .</div>
                                        </div>
                                        {/*salaD()*/}
                                    </div>
                                </div>
