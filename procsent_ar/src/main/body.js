...
function TitleIcK(params) {
    return (
        <> {params.case ? <div className="titleKic"><a className="atitleKic" href={params.link}><FontAwesomeIcon icon={faLink}/> </a></div> : ""} </>
    )
}
